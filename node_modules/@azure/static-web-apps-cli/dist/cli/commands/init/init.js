...
async function promptConfigSettings(disablePrompts, detectedConfig) {
    ...
    const response = await (0, prompts_1.promptOrUseDefault)(disablePrompts, [
        ...
        },
        {
            ...
            choices: (prev) => (0, functions_versions_1.getChoicesForApiLanguage)(prev),
        },
        {
            type: "text",
...
function printFrameworkConfig(config) {
    ...
    utils_1.logger.log(`- API language: ${chalk_1.default.green((_c = config.apiLanguage) !== null && _c !== void 0 ? _c : "")}`);
    utils_1.logger.log(`- API version: ${chalk_1.default.green((_d = config.apiVersion) !== null && _d !== void 0 ? _d : "")}`);
    utils_1.logger.log(`- App build command: ${chalk_1.default.green((_e = config.appBuildCommand) !== null && _e !== void 0 ? _e : "")}`);
    utils_1.logger.log(`- API build command: ${chalk_1.default.green((_f = config.apiBuildCommand) !== null && _f !== void 0 ? _f : "")}`);
    utils_1.logger.log(`- App dev server command: ${chalk_1.default.green((_g = config.appDevserverCommand) !== null && _g !== void 0 ? _g : "")}`);
    utils_1.logger.log(`- App dev server URL: ${chalk_1.default.green((_h = config.appDevserverUrl) !== null && _h !== void 0 ? _h : "")}\n`);
    utils_1.logger.log(`- API dev server URL: ${chalk_1.default.green((_j = config.apiDevserverUrl) !== null && _j !== void 0 ? _j : "")}\n`);
}
